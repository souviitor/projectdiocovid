...
colunas = ['Novos óbitos','Novos casos','Óbitos por 100 mil habitantes',
...
fig.update_layout( xaxis_title='Data', yaxis_title=column.upper(), title = {'x':0.4})

#st.title('DADOS COVID - BRASIL')
st.markdown("<h1 style='text-align: center;'>DADOS COVID - BRASIL</h1>", unsafe_allow_html=True)
st.write('')
